                  ...
                  <div class="hpanel">
                     <div class="panel-body">
                        <div class="text-center">
						   @if(Auth::guest())  
								<h2 class="m-b-xs"><a href="{{ route('login') }}"><i class="fa fa-pdf"></i> {{ $post->title }}</a></h2>
							@else
						...
						@if(Auth::guest())  
                           <a class="btn btn-blue btn-sm mt-2" href="{{ route('login') }}">Download</a>
						@else
                           <a class="btn btn-blue btn-sm mt-2" href="{{ route('post', $post->slug) }}">Download</a>
						@endif
                        </div>
                     </div>
                  </div>
